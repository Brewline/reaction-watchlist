 ...
 * @returns {number} Number of products
 */
export function saveWatchlistItem(userId, shopId, watchlist, data) {
  check(userId, String);
  check(shopId, String);
  check(watchlist, String);
  check(data, Object);
...
Meteor.methods({
  "watchlist/save"(watchlist, data) {
    const userId = Meteor.userId();
    const shopId = Reaction.getShopId();

    return saveWatchlistItem(userId, shopId, watchlist, data);
  },
